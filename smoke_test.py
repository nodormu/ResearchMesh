...
def check_run_loop_tool_use_lifecycle() -> None:
    ...
    try:
        ...
        c2b.messages = [
            ...
            # Nothing follows -- the dangling block is the very last thing.
        ]
        ...
        if this_turn_assistant5:
            ...
            check(
                "excise: unrelated text content NOT wiped",
                "text" in kinds5, str(kinds5),
            )
        check("excise: no orphan left behind", not _orphaned_tool_uses(c5.messages))
        check(
